...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: harsh Agarwal</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;">|| PIET18CS058 || Sec: B || Roll No 01 ||</p></center>
   </div>
   </div>
   </div>
   """
    ...
    if st.button("About"):
      st.subheader("Developed by harsh Agarwal")
